...
$$
[^_^]:{{{\sigma_0(x)=6}\over{\langle x,\sigma_0 \rangle \Downarrow 6}}
[^_^]:;\langle 6\leq5,\sigma_0 \rangle  \Downarrow \text{false}}
[^_^]:;\over{\langle x\leq 5 ,\sigma_0 \rangle \Downarrow \text{false}
[^_^]:;\over \langle \text{while} x\leq5 \text{do}x:=1+1,\sigma_0 \rangle \Downarrow\sigma_0}
$$
