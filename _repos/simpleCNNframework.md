...
excerpt: 'This is the course project for CS385. The goal in this project is to implement comman ML algorithms and frameworks with a language, but I choose C++ to challenge myself(, but turned to python for face recognition to finish the project in time)'
date: 2019-07-29
# venue: 'ieee-cyber'
